//
//  ATCStripeSettingsViewController.swift
...
class ATCStripeSettingsViewController: UITableViewController {
    var settings: ATCStripeSettings {
        return ATCStripeSettings(theme: self.theme.stpTheme,
