//
//  ATCStripeCheckoutViewController.swift
...
class ATCStripeCheckoutViewController: UIViewController, STPPaymentContextDelegate {
    ...
    let backendBaseURL: String? = "https://ios-app-templates-stripe.herokuapp.com"
    ...
    let companyName = "iOS App Templates"
    let paymentCurrency = "usd"

    let paymentContext: STPPaymentContext

    let theme: STPTheme
    let paymentRow: ATCStripeCheckoutRowView
    let shippingRow: ATCStripeCheckoutRowView
    let totalRow: ATCStripeCheckoutRowView
    let buyButton: ATCStripeBuyButton
    ...
    init(product: String = "", price: Int, settings: ATCStripeSettings) {
        ...
        ATCStripeMyAPIClient.sharedClient.baseURLString = self.backendBaseURL
        ...
        self.shippingRow = ATCStripeCheckoutRowView(title: self.shippingString,
                                           detail: "Enter \(self.shippingString) Info",
            theme: settings.theme)
        self.totalRow = ATCStripeCheckoutRowView(title: "Total", detail: "", tappable: false,
                                        theme: settings.theme)
        self.buyButton = ATCStripeBuyButton(enabled: true, theme: settings.theme)
    ...
    func paymentContext(_ paymentContext: STPPaymentContext, didCreatePaymentResult paymentResult: STPPaymentResult, completion: @escaping STPErrorBlock) {
        ATCStripeMyAPIClient.sharedClient.completeCharge(paymentResult, amount: self.paymentContext.paymentAmount, completion: completion)
    }
